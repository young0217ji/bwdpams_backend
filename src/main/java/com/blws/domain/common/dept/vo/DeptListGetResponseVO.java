package com.blws.domain.common.dept.vo;
...
@Getter
public class DeptListGetResponseVO {
  ...
  @Builder
  private DeptListGetResponseVO(Long id, String name, Long parentsId, String remark, Long createdBy,
      LocalDateTime createdDate, Long lastModifiedBy, LocalDateTime lastModifiedDate) {
    this.id = id;
    this.name = name;
  ...
  public static DeptListGetResponseVO of(DeptEntity deptInfo) {
